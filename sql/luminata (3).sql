...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-11-2022 a las 03:02:03
...
--
-- Base de datos: `luminata`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tb_carrinho`
--
...
--
-- Volcado de datos para la tabla `tb_carrinho`
--
...
(26, 1, '2022-11-09', 43, 10, 39090, 'SEPARANDO'),
(27, 1, '2022-11-25', 44, 10, 199090, 'SEPARANDO'),
(28, 3, '2022-11-09', 45, 8, 132000, 'SEPARANDO'),
(29, 2, '2022-11-09', 46, 6, 369000, 'SEPARANDO');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tb_cartao`
--
...
--
-- Volcado de datos para la tabla `tb_cartao`
--
...
(43, 'Keith', 'GonÃ§alves', 'fem', '2004-09-23', '33535353768', 18740000, 'Taquarituba - SP', 'Centro', 'Rua Zico Leonel', 75),
...
--
-- Estructura de tabla para la tabla `tb_codigo_prod`
--
...
--
-- Volcado de datos para la tabla `tb_codigo_prod`
--
...
--
-- Estructura de tabla para la tabla `tb_item_carrinho`
--
...
--
-- Volcado de datos para la tabla `tb_item_carrinho`
--
...
--
-- Estructura de tabla para la tabla `tb_produto`
--
...
--
-- Volcado de datos para la tabla `tb_produto`
--

INSERT INTO `tb_produto` (`COD_PRODUTO`, `MARCA`, `CATEGORIAS`, `NOME`, `MODELO`, `DESCRICAO`, `PRECO`, `ESTOQUE`) VALUES
(63, 1, 2, 'Óculos de Grau Ana Hickmann ', 'AH1386', ' Ana Hickmann Eyewear sabe que cada pequeno detalhe na peça é fundamental para alcançar a perfeição nos óculos. Muito além de apenas superioridade nas armações e lentes, a marca investe em pequenos integrantes dos óculos, como plaquetas, parafusos, elementos decorativos, pintura e tingimento. Suas coleções são dotadas de elegância e sofisticação, perfeitas para mulheres modernas sem fugir do requinte clássico.', '455,00', 1),
...
(10, 41, 'caroline@gmail.com', '12345', 'A'),
...
--
-- Estructura de tabla para la tabla `tb_varias_img`
--
...
--
-- Volcado de datos para la tabla `tb_varias_img`
--
...
--
-- Indices de la tabla `tb_carrinho`
--
...
--
-- Indices de la tabla `tb_codigo_prod`
--
ALTER TABLE `tb_codigo_prod`
  ADD PRIMARY KEY (`COD_CATEGORIA`);

--
-- Indices de la tabla `tb_item_carrinho`
--
...
--
-- Indices de la tabla `tb_produto`
--
...
--
-- Indices de la tabla `tb_varias_img`
--
...
--
-- AUTO_INCREMENT de la tabla `tb_carrinho`
--
ALTER TABLE `tb_carrinho`
  MODIFY `CODIGO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de la tabla `tb_cartao`
--
ALTER TABLE `tb_cartao`
  MODIFY `CODIGO` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Código cartão', AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT de la tabla `tb_produto`
--
ALTER TABLE `tb_produto`
...
--
-- AUTO_INCREMENT de la tabla `tb_varias_img`
--
ALTER TABLE `tb_varias_img`
...
--
-- Filtros para la tabla `tb_item_carrinho`
--
ALTER TABLE `tb_item_carrinho`
...
--
-- Filtros para la tabla `tb_produto`
--
ALTER TABLE `tb_produto`
...
--
-- Filtros para la tabla `tb_varias_img`
--
ALTER TABLE `tb_varias_img`
