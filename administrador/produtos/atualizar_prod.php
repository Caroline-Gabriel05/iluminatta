...
include_once 'conecta2.php';
   ...
   if ( isset($_POST["btn_salvar"]) )
   {
        ...
        if((isset($foto)) and (!empty($foto))){
          ...
          $valor = '../img/produtos/'.$foto;
            ...
            $sqlSEGUNDO = "UPDATE tb_varias_img
                          SET CAMINHO_IMG='$valor' WHERE CHAVE_IMG_PROD = $id";
            ...
            if (!empty($foto2)) 
            {
              ...
              mysqli_query($conn2, "UPDATE tb_varias_img
              SET CAMINHO_IMG='$valor' WHERE CHAVE_IMG_PROD = $id");
      ...
      $sqlPRIMEIRO = "UPDATE tb_produto
	                   SET marca='$marca', categorias='$cat', nome='$nome', modelo='$modelo', descricao='$detalhe', preco='$preco', estoque='$estoq' WHERE COD_PRODUTO= $id ";
   ...
   $sqlImg = "SELECT * FROM TB_VARIAS_IMG
              WHERE CHAVE_IMG_PROD = '$id'";
   $resultImg = mysqli_query($conn2, $sqlImg);

   $sqlconsulta= "SELECT * FROM TB_PRODUTO WHERE COD_PRODUTO = '$id'";
           ...
           <div class="produto">
               <div class="inf_prod">
                   ...
                   <div class="prod_tit">
                       <?php
                           ...
                           if (($result_prod) AND ($result_prod->rowCount() != 0)) {
                               ...
                               extract($row_prod); 
                                   ...
                                   echo "<p class='valor'>Estoque: $ESTOQUE </p>";
                       ...
                       <?php echo "<a class='adm_prod' href='editar_pro.php?id=$codigo'>";?>
